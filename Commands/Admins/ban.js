  ...
  async execute(message, args) {
    ...
    try {
      ...
      const banEmbedDM = new EmbedBuilder()
        .setColor(0xFF0000) 
        .setTitle('**Ban Notice**')
        .setDescription('You have been permanently blacklisted from Welcome to Amoker Clothing and GFX for violating our terms of service, and you are no longer part of our community. If you wish to appeal, please appeal through the appeal form.')
        .addFields(
